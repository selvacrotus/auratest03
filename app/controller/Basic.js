                    ...
                    handler: function () {
                        ...
                        settingslocalStore.each(function (record) {
                            ...
                            loginStore.setProxy({
                                ...
                                url: 'http://1.23.183.6:8085/CrotusValetHandler.ashx?requestname=' + requestno + '&requestcontent=' + paneltext + '&resId=' + record.data.res_id + '&resname=' + record.data.res_name
                 ...
                 /////////           panelrequest='date:'+paneldate+', '+'Time:'+paneltime+', '+'Request:' + panelrequest;
                            ...
                            settingslocalStore.each(function (record) {
                                ...
                                loginStore.setProxy({
                                    ...
                                    url: 'http://1.23.183.6:8085/CrotusValetHandler.ashx?requestname=' + requestno + '&requestcontent=' + panelrequest + '&resId=' + record.data.ResId + '&resname=' + record.data.ResName
    ...
    onaddCartCommand:function(){
        ...
        settingslocalStore.each(function (record) {
            ...
            var rec = {
                ...
                total_price:  parseInt(productDescriptionView.down('#txt4').getValue())+parseInt(productDescriptionView.down('#txt7').getValue()),
                ...
                /*   productDetailQuantity: productDescriptionView.down('#spinQuantity').getValue(),
                 price_net: productDescriptionView.down('#txtProductPrice').getValue(),
                 enterprise_name:  productDescriptionView.down('#txtProductDescrip').getValue()*/
            };
